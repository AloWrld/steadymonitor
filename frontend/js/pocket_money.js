/**
 * Pocket Money Page
 * Handles data loading and UI for Pocket Money
 */

document.addEventListener('DOMContentLoaded', async function() {
    console.log('Pocket Money page initialized');
    ...
    try {
        ...
        console.error('Failed to initialize Pocket Money:', error);
...
async function loadData() {
    ...
    try {
        ...
        // const data = await apiGet(API_ENDPOINTS.POCKET_MONEY_SUMMARY);
        // renderData(data);
        
        console.log('Data loaded for Pocket Money');
